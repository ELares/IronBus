...
//
// VENDORED, PRE-GENERATED CODE -- DO NOT EDIT.
//
// This is the rust-protobuf 2.28 codec for raft-rs's `eraftpb.proto` (the Raft wire
// types: Entry, Message, HardState, ConfState, ConfChange/V2, Snapshot, ...). It was
// generated ONCE, out-of-band, by the PURE-RUST `protobuf-codegen-pure` 2.28 compiler
// (NO `protoc` binary, NO C toolchain) from raft-proto 0.7.0's `proto/eraftpb.proto`,
// then committed here so the IronBus build NEVER runs a protobuf code-generation step.
// This is the "vendor the generated codec" decision (V2-C1): raft-rs is wired in with
// its build-script codec generation eliminated, so the reproducible static-musl build,
// the MSRV-1.78 floor, and the zero-build-script posture are all preserved. See the
// vendored crate's lib.rs for the regeneration recipe.
//
// Upstream raft-proto is Apache-2.0 (c) The TiKV Project Authors; the .proto schema it
// is generated from carries that license. The bytes-for-bytes-fields behavior matches
// raft 0.7's `protobuf-codec` feature (`carllerche_bytes_for_bytes_all` => bytes::Bytes).
...
impl ::protobuf::Message for ConfChangeV2 {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.transition, 1, &mut self.unknown_fields)?
                },
                2 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\reraftpb.proto\x12\x07eraftpb\x1a\x0frustproto.proto\"\xbb\x01\n\x05E\
    ntry\x123\n\nentry_type\x18\x01\x20\x01(\x0e2\x12.eraftpb.EntryTypeR\ten\
    tryTypeB\0\x12\x14\n\x04term\x18\x02\x20\x01(\x04R\x04termB\0\x12\x16\n\
    \x05index\x18\x03\x20\x01(\x04R\x05indexB\0\x12\x14\n\x04data\x18\x04\
    \x20\x01(\x0cR\x04dataB\0\x12\x1a\n\x07context\x18\x06\x20\x01(\x0cR\x07\
    contextB\0\x12\x1b\n\x08sync_log\x18\x05\x20\x01(\x08R\x07syncLogB\0:\0\
    \"w\n\x10SnapshotMetadata\x123\n\nconf_state\x18\x01\x20\x01(\x0b2\x12.e\
    raftpb.ConfStateR\tconfStateB\0\x12\x16\n\x05index\x18\x02\x20\x01(\x04R\
    \x05indexB\0\x12\x14\n\x04term\x18\x03\x20\x01(\x04R\x04termB\0:\0\"[\n\
    \x08Snapshot\x12\x14\n\x04data\x18\x01\x20\x01(\x0cR\x04dataB\0\x127\n\
    \x08metadata\x18\x02\x20\x01(\x0b2\x19.eraftpb.SnapshotMetadataR\x08meta\
    dataB\0:\0\"\xa2\x04\n\x07Message\x121\n\x08msg_type\x18\x01\x20\x01(\
    \x0e2\x14.eraftpb.MessageTypeR\x07msgTypeB\0\x12\x10\n\x02to\x18\x02\x20\
    \x01(\x04R\x02toB\0\x12\x14\n\x04from\x18\x03\x20\x01(\x04R\x04fromB\0\
    \x12\x14\n\x04term\x18\x04\x20\x01(\x04R\x04termB\0\x12\x1b\n\x08log_ter\
    m\x18\x05\x20\x01(\x04R\x07logTermB\0\x12\x16\n\x05index\x18\x06\x20\x01\
    (\x04R\x05indexB\0\x12*\n\x07entries\x18\x07\x20\x03(\x0b2\x0e.eraftpb.E\
    ntryR\x07entriesB\0\x12\x18\n\x06commit\x18\x08\x20\x01(\x04R\x06commitB\
    \0\x12!\n\x0bcommit_term\x18\x0f\x20\x01(\x04R\ncommitTermB\0\x12/\n\x08\
    snapshot\x18\t\x20\x01(\x0b2\x11.eraftpb.SnapshotR\x08snapshotB\0\x12+\n\
    \x10request_snapshot\x18\r\x20\x01(\x04R\x0frequestSnapshotB\0\x12\x18\n\
    \x06reject\x18\n\x20\x01(\x08R\x06rejectB\0\x12!\n\x0breject_hint\x18\
    \x0b\x20\x01(\x04R\nrejectHintB\0\x12\x1a\n\x07context\x18\x0c\x20\x01(\
    \x0cR\x07contextB\0\x121\n\x13deprecated_priority\x18\x0e\x20\x01(\x04R\
    \x12deprecatedPriorityB\0\x12\x1c\n\x08priority\x18\x10\x20\x01(\x03R\
    \x08priorityB\0:\0\"S\n\tHardState\x12\x14\n\x04term\x18\x01\x20\x01(\
    \x04R\x04termB\0\x12\x14\n\x04vote\x18\x02\x20\x01(\x04R\x04voteB\0\x12\
    \x18\n\x06commit\x18\x03\x20\x01(\x04R\x06commitB\0:\0\"\xb8\x01\n\tConf\
    State\x12\x18\n\x06voters\x18\x01\x20\x03(\x04R\x06votersB\0\x12\x1c\n\
    \x08learners\x18\x02\x20\x03(\x04R\x08learnersB\0\x12)\n\x0fvoters_outgo\
    ing\x18\x03\x20\x03(\x04R\x0evotersOutgoingB\0\x12%\n\rlearners_next\x18\
    \x04\x20\x03(\x04R\x0clearnersNextB\0\x12\x1f\n\nauto_leave\x18\x05\x20\
    \x01(\x08R\tautoLeaveB\0:\0\"\x93\x01\n\nConfChange\x12:\n\x0bchange_typ\
    e\x18\x02\x20\x01(\x0e2\x17.eraftpb.ConfChangeTypeR\nchangeTypeB\0\x12\
    \x19\n\x07node_id\x18\x03\x20\x01(\x04R\x06nodeIdB\0\x12\x1a\n\x07contex\
    t\x18\x04\x20\x01(\x0cR\x07contextB\0\x12\x10\n\x02id\x18\x01\x20\x01(\
    \x04R\x02idB\0:\0\"k\n\x10ConfChangeSingle\x12:\n\x0bchange_type\x18\x01\
    \x20\x01(\x0e2\x17.eraftpb.ConfChangeTypeR\nchangeTypeB\0\x12\x19\n\x07n\
    ode_id\x18\x02\x20\x01(\x04R\x06nodeIdB\0:\0\"\xa4\x01\n\x0cConfChangeV2\
    \x12?\n\ntransition\x18\x01\x20\x01(\x0e2\x1d.eraftpb.ConfChangeTransiti\
    onR\ntransitionB\0\x125\n\x07changes\x18\x02\x20\x03(\x0b2\x19.eraftpb.C\
    onfChangeSingleR\x07changesB\0\x12\x1a\n\x07context\x18\x03\x20\x01(\x0c\
    R\x07contextB\0:\0*J\n\tEntryType\x12\x0f\n\x0bEntryNormal\x10\0\x12\x13\
    \n\x0fEntryConfChange\x10\x01\x12\x15\n\x11EntryConfChangeV2\x10\x02\x1a\
    ...
    e\x10\x11\x12\x1d\n\x19MsgRequestPreVoteResponse\x10\x12\x1a\0*>\n\x14Co\
    nfChangeTransition\x12\x08\n\x04Auto\x10\0\x12\x0c\n\x08Implicit\x10\x01\
    \x12\x0c\n\x08Explicit\x10\x02\x1a\0*C\n\x0eConfChangeType\x12\x0b\n\x07\
    AddNode\x10\0\x12\x0e\n\nRemoveNode\x10\x01\x12\x12\n\x0eAddLearnerNode\
    \x10\x02\x1a\0B\x04\x98\xa7\x08\x01b\x06proto3\
";
