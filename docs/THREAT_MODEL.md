...
| Optional at-rest AEAD encryption (AES-256-GCM / ChaCha20-Poly1305) and its interaction with checksums and recovery, specified in [AT_REST_ENCRYPTION.md](AT_REST_ENCRYPTION.md) | **NOT implemented** (no AEAD provider linked) | #780 |
